...
class clinicdetail
{
	...
	void showclinicdata()
	{
		//cout<<"\n\t\t"<<services<<"  "<<roomno<<"  "<<hosph<<"  "<<clinicmail<<"\n";
	     cout<<"\n***********************************************####*****************************************************************************";
	     cout<<"\n\tClinic services:"<<services;
	     cout<<"\n\tRoom number:"<<roomno;
	     cout<<"\n\tClinic room phone num:"<<hosph;
 ...
 void deleteclinicdetail(char*);
 void searchospidata( char *); 
}; 
void clinicdetail::searchospidata(char *a)
{ int counter=0;
	ifstream fin;
...
void clinicdetail::deleteclinicdetail(char *e)
{ int pos,flag=0;
ifstream fin;
fin.open("hsdetail.dat",ios::in|ios::binary);
ofstream fout;
...
else
{
 ...
 void clinicdetail::viewalldetails()
 {
 	ifstream fin;
 ...
 fin.close();
  ...
  void clinicdetail::updatehsdetail(char *t)
  {
...
cout<<"\t\t\t\t\t\t _________________________________________________________________ \n";
cout<<"\t\t\t\t\t\t|                                            	                  |\n";
cout<<"\t\t\t\t\t\t|             1  >> Add a clinic details                          |\n";
cout<<"\t\t\t\t\t\t|             2  >> View clinic details                           |\n";
cout<<"\t\t\t\t\t\t|             3  >> Delete clinic details                         |\n";
cout<<"\t\t\t\t\t\t|             4  >> Update clinic details                         |\n";
cout<<"\t\t\t\t\t\t|             5  >> Search clinic details                         |\n";
cout<<"\t\t\t\t\t\t|             6  >> Back                                          |\n";
cout<<"\t\t\t\t\t\t|                             Enter your choice....               |\n"; 
cout<<"\t\t\t\t\t\t|_________________________________________________________________|\n\n";
han:cout<<"\t\t\t\t\t\t ";cin>>ap;
...
////		 for(int i=0;strlen(scontact);i++)   //validation for phone number
//     {
...
int patientdetail::existingAppointment()
{
    system("cls");
...
int patientdetail::bookAppointment()
{
    system("cls");
...
cout<<"\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t@@|                                          		                                  |@@\n";
cout<<"\t\t\t\t@@|           1 >> Clinic details                  		                          |@@\n";
cout<<"\t\t\t\t@@|           2 >> Staff details                              		                  |@@\n";
cout<<"\t\t\t\t@@|           3 >> Patient details                                                        |@@\n";
//cout<<"\t\t\t\t@@|           x >> Staff workshedule                                                      |@@\n";
cout<<"\t\t\t\t@@|           4 >> Appointment Booking                                                    |@@\n";
cout<<"\t\t\t\t@@|           5 >> Exit                                                                   |@@\n";
cout<<"\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t@@|                                                                                       |@@\n";
 ...
 case '1':
 {
	...
	{ 
		...
		case '3':
			...
			char servicename[25];
			cin>>servicename;
			h1.deleteclinicdetail(servicename);
			getch();
			system("cls");
			break;
		case '4':
...
if(ap>54||ap<49)
{cout<<"\n\n\t\t\t\t\t\tInvalid choice\n";cout<<"\t\t\t\t\t\tTry again...........\n\n";goto add;} //if inputed stk is other than given stk
...
case '1':
	...
	break;}
			case 2:p3.existingAppointment(); break;
			case 0: 
			{ system("cls");
			goto auy;
			cout<<"Thank you";
